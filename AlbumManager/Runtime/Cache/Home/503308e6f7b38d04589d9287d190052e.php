        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="/album/admin.php?a=picmgr">相册管理</a></li>
              <li><a href="/album/admin.php?a=comments">留言管理</a></li>
              <li><a href="/album/admin.php?a=usercenter">用户中心</a></li>
              <li class="active"><a href="/album/admin.php?a=settings">相册设置</a></li>
...
<!-- 模态框结束 -->
    ...
    <div class="container">
      ...
      <div id="config_panel">
        <form method="post" action="/album/admin.php?a=settings" class="form-inline">
          	<br>
        	<label for="album_name">相册名称：</label>
        	<input type="text" name="album_name" id="album_name" placeholder="在此键入相册名称" value="<?php echo ($album_name); ?>" />
        	<label for="album_introduction">相册简介：</label>
        	<input type="text" name="album_introduction" id="album_introduction" placeholder="在此键入相册简介" value="<?php echo ($album_introduction); ?>" />
          	<label for="album_author">相册作者：</label>
        	<input type="text" name="album_author" id="album_author" placeholder="在此键入相册作者" value="<?php echo ($album_author); ?>" />
          	<br><br>
          	<label for="album_bgm">背景音乐：</label>
        	<input type="text" name="album_bgm" id="album_bgm" placeholder="在此键入背景音乐" value="<?php echo ($album_bgm); ?>" />
        	<label for="album_twitter">推特社交：</label>
        	<input type="text" name="album_twitter" id="album_twitter" placeholder="在此键入推特地址" value="<?php echo ($album_twitter); ?>" />
        	<label for="album_facebook">脸书社交：</label>
        	<input type="text" name="album_facebook" id="album_facebook" placeholder="在此键入脸书地址" value="<?php echo ($album_facebook); ?>" />
          	<br><br>
          	<label for="album_github">Github：</label>
        	<input type="text" name="album_github" id="album_github" placeholder="在此键入Github地址" value="<?php echo ($album_github); ?>" />
          	<label for="album_copyright">站点版权：</label>
        	<input type="text" name="album_copyright" id="album_copyright" placeholder="在此键入站点版权" value="<?php echo ($album_copyright); ?>" />
        	<br><br>
