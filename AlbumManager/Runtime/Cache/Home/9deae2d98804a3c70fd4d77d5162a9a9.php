...
<!-- 模态框结束 -->
    ...
    <div class="container">
      ...
      <script>
      	$.ajax({
           	url:'/PHPAlbum/admin.php?c=UserManager&a=pullUserList',
           	type:'post',
           	dataType: 'xml',
            data: {
				act: 'full',
				...
				$(ResponseText).find('item').each(
					function () {
						...
						var name = $(this).find('username').text();
                       	...
                       	response_str += "<tr><td>" + id + "</td><td>" + name + "</a></td><td>" + mail + "</td><td><a href='/PHPAlbum/admin.php?c=UserManager&a=index&uid=" + id + "'>编辑</a></td></tr>";
					}
				);
				response_str += "</table>";
