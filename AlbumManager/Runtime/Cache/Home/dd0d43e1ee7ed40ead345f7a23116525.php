        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="/album/admin.php?a=comments">留言管理</a></li>
...
<!-- 模态框结束 -->
    ...
    <div class="container">
      ...
      <script>
      	$.ajax({
           	url:'/album/index.php?c=ajax&a=getcmts',
           	type:'post',
           	dataType: 'xml',
            data: {
				act: 'full',
				...
				$(ResponseText).find('item').each(
					function () {
						...
						var name = $(this).find('name').text();
                       	...
                       	response_str += "<tr><td>" + i + "</td><td>" + cid + "</td><td>" + name + "</td><td>" + contact + "</td><td>" + message + "</td><td>" + time + "</td><td><a href='javascript:void(0);' onclick='return doCmtDel()'>删除</a></td></tr>";
                       	i=i+1;
					}
				);
				response_str += "</table>";
