...
<html lang="zh">
  <head>
    ...
    <script>
        ...
        if (confirm('确认上传？')) {
        	$.ajax({
        		url:'/PHPAlbum/index.php?c=ajax&a=upload',
           		type:'post',
            	dataType: 'xml',
          		data: {
            	...
            	success: function (ResponseText) {
                	...
                	if (code == 200) {
                  		alert("恭喜您，相片添加成功！");
                  		document.location="/PHPAlbum/admin.php?a=picmgr";
                	}
                	else if (code == 403) {
...
<!-- 模态框结束 -->
    ...
    <div class="container">
      ...
      <h1>相册内容管理</h1>
      <p>
      Album Content Manager
      </p>
      <div id="uploader">
        <h2>相片上传</h2>
        <form method="post" action="" onsubmit="return doAjaxUpload()">
